 ...
 * forms (trailing slash optional), or a bare id. The reference regex was search-anchored and accepted any
 * URL ending in an alphanumeric token; this version is anchored at both ends so `.../q/<id>` is rejected.
 */
